...
public static  final  String Now_Playing =
        "https://api.themoviedb.org/3/discover/movie?api_key=8eb58870b5de5cb9bc488acbde9db02f&language=en-US&sort_by=now_playing&include_adult=false&include_video=false&page=1";
}
